...
function draw() {
	...
	// * might have to chnage this
	var dec = fft.analyze();

	console.log(`analysis - ${fft.analyze()}`)
	...
	console.log(dec) // <-- value stored by fft.analysis()
	...
	var color_index = map(decibel, min, max, 0, colorPalette.length())
