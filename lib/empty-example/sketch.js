...
function draw() {
	...
	// color_index =
	// (isNaN(parseInt(map(decibel, -60, 0, 0, colorPalette.length))) || parseInt(map(decibel, -60, 0, 0, colorPalette.length)) < 0)
	// ? (color_index = 0) : (parseInt(map(decibel, -60, 0, 0, colorPalette.length)))
