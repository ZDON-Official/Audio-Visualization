...
light pink ff69b4, orange ffa500
*/
var colorPalette = ['#38598c', '#ff0000', '#330099', '#0000ff', '#33ffff', '#006633', '#00ff00', '#99ff66', '#ffff00', '#ff69b4', '#ffa500'];
...
function draw() {
	...
	// map decibel values by increments of 10, where decibel ranges from -80 to 0
	var color_index = -100; 
	if (decibel <= -80 || (decibel >= -80 && decibel < -70)){
		color_index = 0;
	}
	else if (decibel >= -70 && decibel < -60){
		color_index = 1;
	}
	else if (decibel >= -60 && decibel < -50){
		color_index = 2;
	}
	else if (decibel >= -50 && decibel < -40){
		color_index = 3;
	}
	else if (decibel >= -40 && decibel < -30){
		color_index = 4;
	}
	else if (decibel >= -30 && decibel < -20){
		color_index = 5;
	}
	else if (decibel >= -20 && decibel < -10){
		color_index = 6;
	}
	else if (decibel >= -10 && decibel < 0){
		color_index = 7;
	}
	...
	for (let i = 0; i < 360; i++) {
		...
		stroke(colorPalette[color_index]); // TODO check why color doesnt change
		// stroke(255)
